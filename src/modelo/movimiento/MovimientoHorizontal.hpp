#ifndef SRC_MODELO_MOVIMIENTO_MOVIMIENTOHORIZONTAL_HPP_
#define SRC_MODELO_MOVIMIENTO_MOVIMIENTOHORIZONTAL_HPP_
...
#endif /* SRC_MODELO_MOVIMIENTO_MOVIMIENTOHORIZONTAL_HPP_ */
